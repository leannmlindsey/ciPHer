...
EXTRACTIONS=(
    ...
    # ESM-2 650M per-residue (full) — DISABLED 2026-05-01: full embeddings
    # didn't deliver in LA experiments and the disk space is being reclaimed
    # for the 3B segment extraction below. Uncomment if revisiting LA work.
